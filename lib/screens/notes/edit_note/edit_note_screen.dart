...
class _EditNoteScreenState extends State<EditNoteScreen> {
  ...
  void initState() {
    ...
    dateController.text =
        '${widget.note.date.month}-${widget.note.date.day}-${widget.note.date.year}';
    tagController.text = widget.note.tag;
    noteController.text = widget.note.note;
    _selectedImportance = widget.note.importance;
    super.initState();
  }
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (nameController.text.isNotEmpty &&
                        ...
                        if (nameController.text != widget.note.name ||
                            date != widget.note.date ||
                            tagController.text != widget.note.tag ||
                            noteController.text != widget.note.note ||
                            _selectedImportance != widget.note.importance) {
